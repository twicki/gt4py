...
class TestDataDimensions:
    ...
    def test_indirect_access_read(self):
        ...
        assert isinstance(
            def_ir.computations[0].body.stmts[0].value.data_index[0], gt_ir.nodes.ScalarLiteral
        )
    ...
    def test_indirect_access_write(self):
        ...
        assert isinstance(
            def_ir.computations[0].body.stmts[0].target.data_index[0], gt_ir.nodes.ScalarLiteral
        )
